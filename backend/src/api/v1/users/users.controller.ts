import { Controller, HttpException, HttpStatus, Get, Post, Patch, Delete, Body, Param, UseGuards } from '@nestjs/common';
import { ApiTags, ApiOperation, ApiOkResponse, ApiForbiddenResponse, ApiBadRequestResponse } from '@nestjs/swagger';
...
export class UsersController {
  ...
  @ApiForbiddenResponse({ description: 'Not enough permissions to execute this request' })
  @ApiBadRequestResponse({ description: 'Not enough permissions to execute this request' })
  ...
  @ApiOkResponse({ description: 'Successfully got all the data from the users table', type: Array<UserInfoDto> })
  @ApiForbiddenResponse({ description: 'Not enough permissions to execute this request' })
  ...
  @ApiOkResponse({ description: 'Successfully got an user data from the users table', type: Array<UserInfoDto> })
  @ApiForbiddenResponse({ description: 'Not enough permissions to execute this request' })
